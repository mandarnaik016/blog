...
{% include lazyimg.html img_src="../assets/img/analysis/easy/lowly/account_name_of_infected_system.png" img_datasrc="../assets/img/analysis/easy/snaccount_name_of_infected_system.pngort-alert-count.png" img_caption="Figure 5: Account name" img_alt="Account name" %}
